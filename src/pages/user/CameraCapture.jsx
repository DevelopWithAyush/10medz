  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      >
        ...
        />
        <div className="absolute inset-4 border-4 border-lime-500 pointer-events-none"></div>{" "}
        {/* Green border */}
      </div>

      <div className="px-5 py-[10px] fixed bottom-0 left-0 w-full">
        <div
          className="px-5 py-[10px] rounded-[10px] flex flex-row items-center border-[1px] border-solid border-[#DFE7F2] justify-between mt-4"
        ...
        <div className="w-full flex flex-col items-start justify-normal bg-white h-[calc(100%-44px)] overflow-y-auto rounded-t-[20px]">
          <div className="flex flex-col items-start justify-start gap-2 px-9 py-6">
            ...
            <p className="text-[12px] font-pregular_400 text-[#101010]">
              Verify readability of the prescription. If the picture is blur or
              too dark, try retaking a picture.
            </p>
          </div>
          ...
          <div className="flex flex-col w-full self-end items-start justify-start px-5 mt-10 gap-6 pb-4">
            <button className="w-full flex flex-col items-center justify-center text-[16px] font-psemibold_600 py-2 text-primary border-[1px] rounded-[10px] border-solid border-primary">
              Retake
            </button>
            <button className="w-full flex flex-col items-center justify-center text-[16px] font-psemibold_600 py-2 text-[#FFF] bg-primary rounded-[10px]">
              Upload
            </button>
          </div>
        </div>
